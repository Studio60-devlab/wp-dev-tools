...
sudo apt-get install -y build-essential terminator bleachbit htop vim git  &&
clear ;
echo ' Install google chrome';sleep 3; 
curl --silent https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb -o gc.deb -C - && sudo gdebi gc.deb ;
rm -Rf gc.deb ;
clear ;
echo ' setup Visual studio code';sleep 3; 
curl --silent https://az764295.vo.msecnd.net/stable/f46c4c469d6e6d8c46f268d1553c5dc4b475840f/code_1.27.2-1536736588_amd64.deb -o VSCODE.deb -C - && 
...
curl --silent -sL https://deb.nodesource.com/setup_8.x | sudo -E bash - && sudo apt-get install -y nodejs
clear; 
...
clear;
echo '1ere phase terminée';sleep 3; clear;
echo 'installation environnement apache php mariadb';sleep 3; clear; 
echo ;
...
curl --silent https://raw.githubusercontent.com/wp-cli/builds/gh-pages/phar/wp-cli.phar --output wpcli ;
